...
const featuredProjects = [
    ...
    },
    {
        ...
        description: "A high-performance automated commerce engine featuring an LLM-powered style assistant, real-time inventory alerts, and a custom DevOps pipeline on AWS.",
        fullDescription: "NEXTZEN is a high-performance e-commerce platform specializing in men's apparel, engineered for viral growth. It integrates a Gemini-powered AI chatbot for contextual styling advice and a robust dashboard-driven inventory system. The custom DevOps pipeline handles media-rich content via S3, automating deployments to AWS EC2 using Docker containers. Developed with the MERN stack and Next.js, it ensures a scalable, secure, and globally fast shopping experience with integrated Razorpay payments.",
        tags: ["MERN Stack", "Next.js", "Gemini AI", "AWS S3/EC2", "Docker", "CI/CD"],
        stats: { scale: "AWS Scalable", performance: "Global Speed", tech: "MERN + AI + DevOps", security: "Secure CI/CD" },
        features: ["LLM-Powered Style Assistant", "Dashboard Inventory Alerts", "Automated CI/CD (Docker)", "AWS S3 Media Delivery", "Secure Payment Gateway", "Containerization"],
        image: "/projects/nextzen-project2.png",
        link: "https://nextzen.mubashiir.in",
    },
    {
        title: "NUVEE",

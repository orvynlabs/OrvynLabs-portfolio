...
const services = [
    {
        ...
        title: 'Development',
        description:
            'High-performance engineering focusing on structure and scalability. We build digital infrastructure that grows with your business.',
        features: ['Full-stack MERN & Next.js', 'Mobile-first App Development', 'SaaS & Membership Platforms'],
        color: '#ffffff',
    },
    {
        icon: Palette,
        ...
        description:
            'Technical aesthetics meet functional design. We create modern, high-fidelity interfaces using our signature glassmorphism style.',
        features: ['Modern Glassmorphism UI/UX', 'Poster & Brand Design', 'Digital Products (Assets)'],
        color: '#ffffff',
    },
    {
        icon: TrendingUp,
        title: 'Growth & Ads',
        description:
            'Data-driven scaling strategies. We optimize your digital presence to ensure maximum reach and conversion for your startup.',
        features: ['Meta Ads (FB & Insta)', 'SEO & Analytics', 'Digital Marketing & SMM'],
        color: '#ffffff',
    },
    {
        icon: Cpu,
        ...
        description:
            'The architectural foundation for startup success. We help founders avoid technical debt through properly structured systems.',
        features: ['Startup MVP Development', 'AI Chatbots & Automation', 'SaaS Architecture Consulting'],
        color: '#ffffff',
    },
    {
        icon: Search,
        title: 'Google Business Profile Building',
        description:
            'Establish authority and credibility locally. We optimize your Google Business Profile to boost local search visibility and drive direct conversions.',
